...
const Header = () => {
  return (
    <header className=' flex items-center justify-between p-6 bg-gradient-to-r from-cyan-500 to-blue-500 text-white shadow-lg'>
      {/* Left-hand side logo and college name */}
      <div className='flex items-center'>
        <img src={logo} alt='Logo' className='w-30 h-14 mr-2 rounded-full' />
